...
{/*The declare keyword tells TypeScript that you're just declaring the shape
It’s a type assertion, helping TypeScript understand the possible shape of the data.as User | null → Type hint*/}